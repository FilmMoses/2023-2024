...
pros::controller_digital_e_t controlSwitchButton = pros::E_CONTROLLER_DIGITAL_X;
...
pros::controller_digital_e_t latchButton = pros::E_CONTROLLER_DIGITAL_A;
pros::controller_digital_e_t unlatchButton = pros::E_CONTROLLER_DIGITAL_Y;
pros::controller_digital_e_t matchLoadButton = pros::E_CONTROLLER_DIGITAL_Y;

// Matt

// pros::controller_digital_e_t rightWingButton = pros::E_CONTROLLER_DIGITAL_L1;
// pros::controller_digital_e_t leftWingButton = pros::E_CONTROLLER_DIGITAL_L1;
// pros::controller_digital_e_t intakeButton = pros::E_CONTROLLER_DIGITAL_R1;
// pros::controller_digital_e_t outtakeButton = pros::E_CONTROLLER_DIGITAL_R2;
// pros::controller_digital_e_t liftUpButton = pros::E_CONTROLLER_DIGITAL_UP;
// pros::controller_digital_e_t liftDownButton = pros::E_CONTROLLER_DIGITAL_DOWN;
// pros::controller_digital_e_t latchButton = pros::E_CONTROLLER_DIGITAL_A;
// //pros::controller_digital_e_t unlatchButton = pros::E_CONTROLLER_DIGITAL_Y;
// pros::controller_digital_e_t matchLoadButton = pros::E_CONTROLLER_DIGITAL_L2;

// Drive motors.  These are used in GUI and Template
std::vector<int> left_motors = {-7, -6, -8, 20};
std::vector<int> right_motors = {-12, 2, 5, 11};
...
void opcontrol() {
  ...
  while (true) {
    ...
    if (master.get_digital(controlSwitchButton) && !nick && (nickCounter >= 30)){ // NICK CONTROLS
      rightWingButton = pros::E_CONTROLLER_DIGITAL_R1;
      leftWingButton = pros::E_CONTROLLER_DIGITAL_L1;
      intakeButton = pros::E_CONTROLLER_DIGITAL_L2;
      outtakeButton = pros::E_CONTROLLER_DIGITAL_R2;
      matchLoadButton = pros::E_CONTROLLER_DIGITAL_Y;
      nick = true;
    }else if(master.get_digital(controlSwitchButton) && nick && (nickCounter >= 30)){ // MATT CONTROLS
      rightWingButton = pros::E_CONTROLLER_DIGITAL_L1;
      leftWingButton = pros::E_CONTROLLER_DIGITAL_L1;
      intakeButton = pros::E_CONTROLLER_DIGITAL_R1;
      outtakeButton = pros::E_CONTROLLER_DIGITAL_R2;
      //matchLoadButton = pros::E_CONTROLLER_DIGITAL_Y;
      latchButton = pros::E_CONTROLLER_DIGITAL_Y;
      nick = false;
    }
    ...
    // if(master.get_digital_new_press(rightWingButton) && !rightWingExtended){
    //   rightWing.set_value(true);
    //   rightWingExtended = true;
    // }else if(master.get_digital_new_press(rightWingButton) && rightWingExtended){
    //   rightWing.set_value(false);
    //   rightWingExtended = false;
    // }

    // if(master.get_digital_new_press(leftWingButton) && !leftWingExtended){
    //   leftWing.set_value(true);
    //   rightWingExtended = true;
    // }else if(master.get_digital_new_press(leftWingButton) && leftWingExtended){
    ...
    if(master.get_digital(latchButton)){
      liftLock.set_value(true);
    }
    // else if(master.get_digital(unlatchButton)){
    //   liftLock.set_value(true);
    // }
    ...
    if(master.get_digital(matchLoadButton) && !armDown){
      // matchLoader.move(127);
      // matchLoader2.move(127);
      matchLoader.move_absolute(-560, 127);
      matchLoader2.move_absolute(-560, 127);
    }else if(!master.get_digital(outtakeButton) && !armDown){
      matchLoader.move_absolute(0, 127);
      matchLoader2.move_absolute(0, 127);
    }else if(climbing){
      matchLoader.move_absolute(-520, 127);
      matchLoader2.move_absolute(-520, 127);
    }
    ...
    if (master.get_digital(outtakeButton)) {
      ...
      matchLoader.move_absolute(-120, 127);
      matchLoader2.move_absolute(-120, 127);
